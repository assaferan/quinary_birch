...
template<>
SquareMatrixInt<Z64,5> SquareMatrixInt<Z64,5>::operator*(const SquareMatrixInt<Z64,5>& other) const
{
  SquareMatrixInt<Z64,5> prod;
...
template<>
SquareMatrixInt<Z,2> SquareMatrixInt<Z,2>::operator*(const SquareMatrixInt<Z,2>& other) const
{
  SquareMatrixInt<Z,2> prod;
...
template<>
SquareMatrixInt<Z,4> SquareMatrixInt<Z,4>::operator*(const SquareMatrixInt<Z,4>& other) const
{
  SquareMatrixInt<Z,4> prod;
...
// we postpone optimization until everything else works

template<>
SquareMatrixInt<Z64,4> SquareMatrixInt<Z64,4>::operator*(const SquareMatrixInt<Z64,4>& other) const
{
  SquareMatrixInt<Z64,4> prod;
